...
import com.github.sipe90.lunchscraper.serialization.ChatCompletionRequestMessageSerializer
import com.github.sipe90.lunchscraper.serialization.ChatCompletionRequestUserMessageContentPartSerializer
import com.github.sipe90.lunchscraper.serialization.ModelSerializer
...
class Model(
    ...
    companion object {
        fun fromString(str: String): Model {
            ...
            val baseModel = "${parts[0]}-${parts[1]}"
            val specifier = if (parts.size > 2) parts[2] else null

            return Model(baseModel, specifier)
        }
    }
}
...
@Serializable(with = ChatCompletionRequestUserMessageContentPartSerializer::class)
sealed interface ChatCompletionRequestUserMessageContentPart {
    val type: Type
...
data class ChatCompletionRequestUserMessageTextContentPartPart(
    ...
    override val type: ChatCompletionRequestUserMessageContentPart.Type = ChatCompletionRequestUserMessageContentPart.Type.TEXT
}
...
data class ChatCompletionRequestUserMessageUrlContentPartPart(
    ...
    override val type: ChatCompletionRequestUserMessageContentPart.Type = ChatCompletionRequestUserMessageContentPart.Type.IMAGE_URL
}
